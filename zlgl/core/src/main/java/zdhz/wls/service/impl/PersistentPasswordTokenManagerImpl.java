...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see zdhz.wls.service.impl.PasswordTokenManager#generateRecoveryToken(zdhz.wls.model.User)
     */
    @Override
    ...
    /**
     * @see zdhz.wls.service.impl.PasswordTokenManager#isRecoveryTokenValid(zdhz.wls.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see zdhz.wls.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
