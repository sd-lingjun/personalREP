...
import zdhz.wls.dao.UserDao;
import zdhz.wls.model.User;
import zdhz.wls.service.MailEngine;
import zdhz.wls.service.UserExistsException;
import zdhz.wls.service.UserManager;
import zdhz.wls.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "zdhz.wls.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see zdhz.wls.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
